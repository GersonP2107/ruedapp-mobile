...
const DocumentsScreen: React.FC = () => {
  const handleAddDocument = () => {
    Alert.alert('Agregar Documento', 'Funcionalidad en desarrollo');
  };

  const handleViewDocument = (documentType: string) => {
    Alert.alert('Ver Documento', `Visualizando ${documentType}`);
  };

  const handleRenewDocument = (documentType: string) => {
    Alert.alert('Renovar Documento', `Renovando ${documentType}`);
  };

  const handleNotifications = () => {
    Alert.alert('Notificaciones', 'Ver todas las notificaciones');
  };
    ...
    <View style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Gestiona todos tus documentos vehiculares</Text>
          
          <TouchableOpacity style={styles.notificationButton} onPress={handleNotifications}>
            <Ionicons name="notifications" size={16} color="#22c55e" />
            <Text style={styles.notificationText}>2 por vencer</Text>
          </TouchableOpacity>
        </View>
          ...
          <View style={styles.documentCard}>
            ...
            <View style={styles.documentDetails}>
              ...
              <View style={styles.detailRow}>
                ...
                <Text style={styles.detailValue}>15 Dic 2025</Text>
              </View>
              <View style={styles.detailRow}>

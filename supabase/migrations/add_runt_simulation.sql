-- Migración para agregar tabla de simulación del RUNT
-- Fecha: 2024-01-XX
...
ALTER TABLE public.runt_vehicle_data ENABLE ROW LEVEL SECURITY;

-- Política para permitir lectura a usuarios autenticados
CREATE POLICY "Allow read access to authenticated users" ON public.runt_vehicle_data
  FOR SELECT TO authenticated
  USING (true);

-- Política para permitir inserción solo a administradores (opcional)
CREATE POLICY "Allow insert for service role" ON public.runt_vehicle_data

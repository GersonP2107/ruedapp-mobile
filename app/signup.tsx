...
import { validateSignupForm, validateEmail, validateFullName, validatePassword, getPasswordStrength, hasFormErrors, FormErrors } from '@/utils/validation';
...
export default function SignUpScreen() {
  ...
  const handleLegacySignUp = async () => {
    ...
    setIsLoading(true);
    try {
       const success = await register(fullName.trim(), email.trim(), password, phone.trim() || undefined);
      if (success) {
